...
<html lang="en">
<head>
	<title>TeamOn request failed</title>
		...
		<div id="pages">
			...
			<div id="contact" class="page">
				...
				<div class="row">
					<p class="left">
						${error.detail}
						<br/>Please try again and if this continues, please <li class="email"><a href="mailto:support@teamonapp.com" title="support@teamonapp.com">contact us</a></li>
					</p>					
				</div>
