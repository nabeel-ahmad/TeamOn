	...
	<section class="container">
		...
		<div id="pages">
			...
			<div id="contact" class="page">
				...
				<h1>Welcome to TeamOn</h1>
				<p> 
					Thank you for joining TeamOn. Your TeamOn account is: ${user.id}
				</p>
				<br/>
				<p>	
					You can now sign in to the TeamOn app from your smartphone or tablet with the account and password you had set during the sign-up process.
				</p>
