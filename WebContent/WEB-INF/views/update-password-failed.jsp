...
<html lang="en">
<head>
	<title>TeamOn Change Password Failed</title>
	...
	<section class="container">
		...
		<div id="pages">
			...
			<div id="contact" class="page">
				...
				<div class="row">
					<p class="left">
						Your TeamOn change password request failed. Please try again and if this continues, please <li class="email"><a href="mailto:support@teamonapp.com" title="support@teamonapp.com">contact</a></li> us.
					</p>
				</div>
